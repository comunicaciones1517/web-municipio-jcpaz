...
export const metadata: Metadata = {
  title: "Automotor — Tributos | José C. Paz",
  description:
    "Información sobre el tributo de Automotor, lugares y medios de pago en José C. Paz.",
};
    ...
    <div>
      <div className="bg-gradient-to-r from-emerald-700 to-emerald-500 text-white py-10 px-4">
        <div className="mx-auto max-w-4xl">
          ...
          <h1 className="text-3xl font-bold mb-2">Automotor</h1>
        </div>
      </div>
